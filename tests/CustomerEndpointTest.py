...
class TestCustomer(unittest.TestCase):
    ...
    # @patch('...application.customer_service.CustomerService.get_base_plan_suscription_rate')
    ...
    # @patch('...application.customer_service.CustomerService.list_customers')
    ...
    # @patch('...application.customer_service.CustomerService.get_base_plan_issue_fee')
    ...
    # @patch('...application.customer_service.CustomerService.get_channel_by_plan')
    ...
    # @patch('...application.customer_service.CustomerService.get_customer_by_id')
    ...
    # @patch('...application.customer_service.CustomerService.get_plan_by_id')
